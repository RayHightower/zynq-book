...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      axi_lite_wstate <= to_unsigned(0, 8);
      axi_lite_rstate <= to_unsigned(0, 8);
  ...
  axi_lite_output : PROCESS (axi_lite_wstate, axi_lite_rstate, AXI_Lite_AWVALID, AXI_Lite_WVALID, AXI_Lite_BREADY, 
      AXI_Lite_ARVALID, AXI_Lite_RREADY)
  ...
  BEGIN
    ...
    CASE axi_lite_wstate IS
      WHEN "00000000" =>
        ...
        AXI_Lite_BVALID <= '0';
        IF awvalid = '1' THEN 
          axi_lite_wstate_next <= to_unsigned(1, 8);
        ELSE 
          axi_lite_wstate_next <= to_unsigned(0, 8);
        END IF;
      WHEN "00000001" =>
        out0 := '0';
        out1 := '1';
        AXI_Lite_BVALID <= '0';
        IF wvalid = '1' THEN 
          axi_lite_wstate_next <= to_unsigned(2, 8);
        ELSE 
          axi_lite_wstate_next <= to_unsigned(1, 8);
        END IF;
      WHEN "00000010" =>
    ...
    CASE axi_lite_rstate IS
      WHEN "00000000" =>
        ...
        AXI_Lite_RVALID <= '0';
        IF arvalid = '1' THEN 
          axi_lite_rstate_next <= to_unsigned(1, 8);
        ELSE 
          axi_lite_rstate_next <= to_unsigned(0, 8);
        END IF;
      WHEN "00000001" =>
        out3 := '0';
        AXI_Lite_RVALID <= '1';
